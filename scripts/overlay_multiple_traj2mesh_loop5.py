...
parser.add_argument("--aug", type=str, default="loop5")
...
parser.add_argument(
    "--ref",
    type=str,
    default="reference_bunker_arena_loop_reference_trial_1.bag",
...
# ================= OFFSET SETUP ====================
offset_reference_trajectory = [-1.4, -2.95, 1.0]  # forward, side , side toward me
...
if "dino" in algo:
    ...
    rotate_y = 0.0
    rotate_z = 85.0
elif "vint" in algo and len(trials) == 1 and trials[0] != "2":
    offset = [-1.4, -2.95, 1.0]
    rotate_x = 180.0
    rotate_y = 0.0
    rotate_z = 85.0
